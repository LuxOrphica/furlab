...
const file='F:/FURLAB/dev/furlab-access/ui-lab/assets/uploads/FL-SCR-001012_placed.png';
...
console.log(out);
await page.screenshot({ path:'ui-lab/line-direction-visualizer-react/tmp/check_001012_current.png', fullPage:true });
await browser.close();
